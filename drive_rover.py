...
class RoverState():
    def __init__(self):
        ...
        self.stuck_time = None # To record total time stuck
        ...
        self.steering_bias = 15 # steering bias in degrees to hug the walls
        self.max_steer = 15 # maximum turn amount
        ...
        self.pickup_started = False # pickup in progress
        self.rocks_picked_up = 0
        self.pickup_location = []
        self.goal= None   # where robot started
        self.success = False # are we there yet?
        self.back_home = False # did we bring a rock back?
        self.stuck_count = 0 # are we stuck, how long?
        self.backup_count = 0 # are we backing up, how long?
        self.backup_threshold = 150 # how far do we back up when avoiding an obstacle
        self.pid = PID.PID(1.0, 0.1, 0.01)
